...
* Before moving on, as we are using the data-generator, let's add it as sbt dependency in our `build.sbt` file:
...
* Now, let's add the new streaming service to our protocol definition.
